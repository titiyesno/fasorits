...
<section class="content-header">
    <h1>
        Profil fasor
        <small>Add SUB Profil fasor</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url("index.php/home/u") ?>"><i class="fa fa-dashboard"></i> SUB Profil fasor</a></li>
        <li class="active">add sub yidic</li>
    </ol>
</section>
<div class="content">
    <div class="box box-solid">
        <div class="box-header">
            <h3 class="box-title">SUBNAV Profil fasor</h3>
            
        </div>
        <div class="box-body">
            <?php echo form_open_multipart('company/' . $this->session->userdata['logged_in']['privilege'] . '/subs_simpanedit'); ?>
        ...
        <div class="form-group">
            ...
            <input type="hidden" value="<?php echo $berita[0]->idsubnav;?>" name="idsubnav"/>
        </div>
