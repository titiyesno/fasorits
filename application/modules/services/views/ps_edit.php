...
<section class="content-header">
    <h1>
        YIDIC
        <small>Add SUB YIDIC</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url("index.php/home/u") ?>"><i class="fa fa-dashboard"></i> SUB YIDIC</a></li>
...
<div class="content">
    <div class="box box-solid">
        <div class="box-header">
            <h3 class="box-title">SUBNAV YIDIC</h3>
            
        </div>
        <div class="box-body">
            <?php echo form_open_multipart('services/' . $this->session->userdata['logged_in']['privilege'] . '/subs_simpanedit'); ?>
