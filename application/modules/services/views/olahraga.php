                ...
                <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info">
                    <thead>
                        <tr role="row">
                            ...
                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" aria-label="Last Name: activate to sort column ascending" >Nama Olahraga</th>
                    ...
                    <tbody role="alert" aria-live="polite" aria-relevant="all">
                        ...
                        if (isset($item)) {
                            ...
                            foreach ($item as $data) {
                                ...
                                <td class=" "><a class="edit" href="' . base_url("index.php/services/s/ubaholahraga/" . $data->id) . '">Edit</a></td>';
                            }
                        }
                        ?>
                    </tbody>
