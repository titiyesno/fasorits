...
<div class="tabs">
    ...
    <div class="tab-content">
        <div class="active tab-pane" id="tab4-1">
            <form method="POST" action="<?php echo site_url() ?>/pemesanan/s/umum">
        ...
        <div class="tab-pane" id="tab4-2">
            <form method="POST" action="<?php echo site_url() ?>/pemesanan/s/akademik">
                    <div class="form-group">
                        <label>NRP/NIP</label>
                    ...
                    <div class="form-group">
                        ...
                        <!--<div class='input-group date' id='datetimepicker6'>-->
                            <input type='date' name="date" class="form-control" id="tanggalaka" onchange="getslotaka()" />
                            <!--<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
                            </span>
                        </div>-->
                    </div>
        ...
        <div class="tab-pane" id="tab4-3">
            <form method="POST" action="<?php echo site_url() ?>/pemesanan/s/khusus">
                <div class="active tab-pane" id="tab4-1">
                    <div class="form-group">
                        <label>No ID</label>
                        <input class="form-control" type="text" name="noid" placeholder="Isi dengan no NRP anda" />
