...
<div class="content">
                    ...
                    <tbody role="alert" aria-live="polite" aria-relevant="all">
                        ...
                        if (isset($kategori)) {
                            ...
                            foreach ($kategori as $data) {
                                ...
                                <td class=" "><a class="edit" href="' . base_url("index.php/kategori/s/ubahkategori/" . $data->idkategori) . '">Edit</a></td>
                                <td class=" "><a class="delete" href="' . base_url("index.php/kategori/s/hapuskategori/" . $data->idkategori) . '">Delete</a></td></tr>';
                            }
                        }
                        ?>
                    </tbody>
    ...
    <?php $this->load->view('addkategori') ?>
</div>
