...
class image_CRUD {
    ...
    protected $default_language_path = 'gui_modul/image_crud/languages';
    ...
    /* 2 baris di bawah Tambahan Sendiri */
    protected $idberita = '';
    protected $idgaleri = '';
    ...
    protected function _library_view($view, $vars = array(), $return = FALSE) {
        ...
        $view_file = 'gui_modul/image_crud/views/';
    ...
    protected function _get_delete_url($value) {
        ...
        $segments_array = $this->ci->uri->segment_array();                  //tambahan agar controller di subfolder (modul) jalan
        $rsegments_array[1] = $segments_array[1] . '/' . $segments_array[2];    //tambahan agar controller di subfolder (modul) jalan
    ...
    protected function _convert_foreign_characters($str_i) {
        include('gui_modul/image_crud/config/translit_chars.php');
