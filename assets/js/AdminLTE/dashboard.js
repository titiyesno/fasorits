...
$(function() {
    ...
    $('#calendar').fullCalendar({
        ...
        events: [
            {
                title: 'Acara Wisuda ITS 113',
                start: new Date(y, 8, 1),
                url: 'http://localhost/fasor2/index.php/pemesanan/admin/cetakbukti/001920/',
                backgroundColor: "#3c8dbc", //light-blue 
                borderColor: "#3c8dbc" //light-blue
            },
            {
                title: 'Pernikahan Tuan A dan Nyonya B',
            ...
            {
                title: 'Konser Amal ITS',
                start: new Date(y, 8, 3),
                url: 'http://localhost/fasor2/index.php/pemesanan/admin/cetakbukti/001920/',
                backgroundColor: "#f39c12", //yellow
                borderColor: "#f39c12" //yellow
            },
            {
                title: 'Schematics TC ITS 2014',
                start: new Date(y, 8, 4),
                allDay: false,
                url: 'http://localhost/fasor2/index.php/pemesanan/admin/cetakbukti/001920/',
                backgroundColor: "#3c8dbc", //light-blue 
                borderColor: "#3c8dbc" //light-blue
            ...
            {
                title: 'Pertemuan Rektor Se Indonesia',
            ...
            {
                title: 'Pertemuan Ketua BEM Se Indonesia',
                start: new Date(y, 8, 6),
                url: 'http://localhost/fasor2/index.php/pemesanan/admin/cetakbukti/001920/',
               backgroundColor: "#3c8dbc", //light-blue 
                borderColor: "#3c8dbc" //light-blue
            }
