...
class CI_Email {
    ...
    var $useragent = "Asrama ITS";
    var $mailpath = "/usr/sbin/sendmail"; // Sendmail path
    var $protocol = "mail"; // mail/sendmail/smtp
    var $smtp_host = "smtp.its.ac.id";  // SMTP Server.  Example: mail.earthlink.net
    var $smtp_user = "reservasi.asrama@its.ac.id";  // SMTP Username
    var $smtp_pass = "123456aa";  // SMTP Password
