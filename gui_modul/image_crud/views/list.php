<?php
	$this->set_css('gui_modul/image_crud/css/fineuploader.css');
	$this->set_css('gui_modul/image_crud/css/photogallery.css');
	$this->set_css('gui_modul/image_crud/css/colorbox.css');

	$this->set_js('gui_modul/image_crud/js/jquery-1.8.2.min.js');
	$this->set_js('gui_modul/image_crud/js/jquery-ui-1.9.0.custom.min.js');

	$this->set_js('gui_modul/image_crud/js/fineuploader-3.2.min.js');
	
	$this->set_js('gui_modul/image_crud/js/jquery.colorbox-min.js');
?>
<script>
$(function(){
	<?php if ( ! $unset_upload) {?>
