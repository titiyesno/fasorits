...
t.matchMedia=t.matchMedia||function(e,t){
    ...
    init:function(e,t,n,r,i){
        ...
        if(t&&typeof t=="string"&&!/reflow/i.test(t))this.libs.hasOwnProperty(t)&&a.push(this.init_lib(t,u));else for(var f in this.libs)a.push(this.init_lib(f,t));return e
        },
...
reflow:function(){}
    ...
    events:function(n){
        ...
        i(this.scope).off(".dropdown").on("click.fndtn.dropdown","["+this.attr_name()+"]",function(e){
            ...
            if(t.data(r.data_attr()))var n=i("#"+t.data(r.data_attr())),s=t;
            else{
                var n=t;
...
reflow:function(){}
    ...
    validate:function(e,t,n){
        ...
        for(var u=0;u<i;u++)if(!r[u]&&(o||n))return this.settings.focus_on_invalid&&e[u].focus(),s.trigger("invalid"),this.S(e[u]).closest("form").attr(this.invalid_attr,""),!1;return(o||n)&&s.trigger("valid"),s.removeAttr(this.invalid_attr),n?!1:!0
        },
